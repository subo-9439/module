...
public class User extends BaseEntity {
    ...
    @Builder
    public User(Long id, String email, String password, String name, String phone, String nickname,Status status ,Role role,String provider,String providerId) {
        this.id = id;
        this.email = email;
    ...
    private String providerId;  //Oauth
